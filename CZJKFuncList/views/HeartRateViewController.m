...
-(void)viewWillAppear:(BOOL)animated{
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onReadData:) name:notify_key_CZJK_did_read_sensor_report object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onSensorChange:) name:notify_key_CZJK_did_sensor_state_change  object:nil];
