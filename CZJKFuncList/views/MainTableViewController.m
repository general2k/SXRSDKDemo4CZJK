...
-(void)viewWillAppear:(BOOL)animated{
    [self refreshText];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onGetCurrentData:) name:notify_key_CZJK_did_read_current_data object:nil];
...
//    self.navigationController.navigationBar.barTintColor = [UIColor blueColor];
    ...
    self.deviceitemname = @[NSLocalizedString(@"ConnectDefaultDevice", nil),
                            ...
                            NSLocalizedString(@"SetAlarm", nil),
                            NSLocalizedString(@"SetAlarmName", nil),
                            NSLocalizedString(@"SetSedentaryAlarm", nil),
                            NSLocalizedString(@"SetHydrationAlarm", nil),
                            NSLocalizedString(@"HeartRate", nil),
                            NSLocalizedString(@"AntiLost", nil),
                            NSLocalizedString(@"MusicPlayer", nil),
                            NSLocalizedString(@"OpenCamera", nil),
                            NSLocalizedString(@"SendANCSPair", nil)
                            ];
    self.deviceitemtag = @[[NSNumber numberWithInt:FuncConnectDefaultDevice],
                           ...
                           [NSNumber numberWithInt:FuncClear],
                           [NSNumber numberWithInt:FuncCurrentData],
                           [NSNumber numberWithInt:FuncSportData],
                           ...
                           [NSNumber numberWithInt:FuncSetAlarmName],
                           [NSNumber numberWithInt:FuncSedentary],
                           [NSNumber numberWithInt:FuncHydration],
                           [NSNumber numberWithInt:FuncHeartRate],
                           [NSNumber numberWithInt:FuncAntiLost],
                           [NSNumber numberWithInt:FuncMusicPlayer],
                           [NSNumber numberWithInt:FuncTakePhoto],
...
//            [self presentViewController:vc animated:YES completion:nil];
        ...
        case FuncCurrentData:{
            [SXRService GetCurrentData:nil];
        }
            break;
        case FuncSportData:{
            [self performSegueWithIdentifier:@"getsportdata" sender:nil];
        }
            break;
        ...
        case FuncHeartRate:{
            ...
            break;
        case FuncAntiLost:{
            [self performSegueWithIdentifier:@"antilost" sender:nil];
        }
            break;
        case FuncMusicPlayer:{
            [self performSegueWithIdentifier:@"music" sender:nil];
        }
            break;
        case FuncSendANCSPair:{
            [SXRService SendANCSPair:nil];
        }
            break;
        case FuncTakePhoto:{
            [self openCamera];
            ...
            break;
        case FuncSedentary:{
            [self performSegueWithIdentifier:@"sedentary" sender:nil];
        }
            break;
        case FuncHydration:{
            [self performSegueWithIdentifier:@"hydration" sender:nil];
        }
            break;
        ...
        case FuncGetFirmware:{
            ...
            break;
        case FuncSetAlarmName:{
            [self performSegueWithIdentifier:@"setalarmname" sender:nil];
        }
            break;
...
-(void)onCmdFinish:(NSNotification*)notify{
    ...
    switch (substate) {
        case SUB_STATE_CZJK_WAIT_READTIME_RSP:
            if (isok) {
                int year = [[dict objectForKey:CZJK_NOTIFY_PARAM_YEAR] intValue];
                int month = [[dict objectForKey:CZJK_NOTIFY_PARAM_MONTH] intValue];
                int day = [[dict objectForKey:CZJK_NOTIFY_PARAM_DAY] intValue];
                int hour = [[dict objectForKey:CZJK_NOTIFY_PARAM_HOUR] intValue];
                int minute = [[dict objectForKey:CZJK_NOTIFY_PARAM_MINUTE] intValue];
                int second = [[dict objectForKey:CZJK_NOTIFY_PARAM_SECOND] intValue];
                int weekday = [[dict objectForKey:CZJK_NOTIFY_PARAM_WEEKDAY] intValue];
        ...
        case SUB_STATE_CZJK_WAIT_SETTIME_RSP:
            if (isok) {
        ...
        case SUB_STATE_CZJK_WAIT_SETPERSONINFO_RSP:
            ...
            break;
        case SUB_STATE_CZJK_WAIT_SETSLEEPTIME_RSP:
            if (isok) {
                UIAlertController* ac = [UIAlertController alertControllerWithTitle:nil message:NSLocalizedString(@"Set Sleep Time OK", nil) preferredStyle:UIAlertControllerStyleAlert];
                [ac addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
                ...
                UIAlertController* ac = [UIAlertController alertControllerWithTitle:nil message:NSLocalizedString(@"Set Sleep Time Error", nil) preferredStyle:UIAlertControllerStyleAlert];
                [ac addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
        ...
        case SUB_STATE_CZJK_WAIT_SETNOTIFICATION_RSP:
            if (isok) {
                UIAlertController* ac = [UIAlertController alertControllerWithTitle:nil message:NSLocalizedString(@"Set Notify OK", nil) preferredStyle:UIAlertControllerStyleAlert];
                [ac addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
                ...
                UIAlertController* ac = [UIAlertController alertControllerWithTitle:nil message:NSLocalizedString(@"Set Notify Error", nil) preferredStyle:UIAlertControllerStyleAlert];
                [ac addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
            ...
            break;
        case SUB_STATE_CZJK_WAIT_CLEAR_RSP:
            if (isok) {
                UIAlertController* ac = [UIAlertController alertControllerWithTitle:nil message:NSLocalizedString(@"Clear OK", nil) preferredStyle:UIAlertControllerStyleAlert];
                [ac addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
                ...
                UIAlertController* ac = [UIAlertController alertControllerWithTitle:nil message:NSLocalizedString(@"Clear Error", nil) preferredStyle:UIAlertControllerStyleAlert];
                [ac addAction:[UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDestructive handler:^(UIAlertAction * _Nonnull action) {
