...
- (void)viewDidLoad {
    [super viewDidLoad];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onTakePhoto) name:notify_key_did_recv_photo_control object:nil];
    ...
    image.image = [UIImage imageNamed:@"icon_back@2x.png"];
